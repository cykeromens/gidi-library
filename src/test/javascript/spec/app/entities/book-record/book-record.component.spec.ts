...
import { BookRecordComponent } from 'app/entities/book-record/book-record.component';
...
describe('Component Tests', () => {
    describe('BookRecord Management Component', () => {
        let comp: BookRecordComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BookRecordComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bookRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
